...
You can clone the model Quarto document from [GitHub](https://github.com/ealvaradomena/class_repo). The repository is open-access. Please read my blog post about it.
:::
